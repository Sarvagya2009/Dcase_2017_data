...
class create_dataset:
    ...
    def iterbatches(self, batch_size, dataset, labelencoder):
        ...
        while True:
            ...
            for i in range(batch_size):
                ...
                scene_id = labelencoder.transform([row.scene])[0]
                self.n_scenes= len(labelencoder.classes_)
                
                """
                print(spec.shape, "spec shape") GIVES (40,501,1) (long mel band feature shape)
                """
